...
* Updated `Set-AzDiskSecurityProfile` cmdlet
    - Added new business logic to set the SecurityType property to null by default unless the user specifies a value. If a user specifies a value, that value is assigned to SecurityType.
