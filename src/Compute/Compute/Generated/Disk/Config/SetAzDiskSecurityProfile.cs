...
namespace Microsoft.Azure.Commands.Compute
{
    ...
    public class SetAzDiskSecurityProfile : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        ...
        [Parameter(
           Mandatory = false,
           ValueFromPipelineByPropertyName = true,
           HelpMessage = "GallantSecurity of a string type. The only allowed values are DiskSecure, VMSecure, or GallerySecure.")]
        [PSArgumentCompleter("DiskSecure", "VMSecure", "GallerySecure")]
